...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='data/Live_test.mp4', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--classes', default=[0,1,2], nargs='+', type=int,
